...
- 타임테이블은 `12:30~19:00+` 범위를 기준으로 구성되어야 합니다.
...
### FR-029 스폰서 전용 페이지 제공
- 시스템은 `/sponsor` 경로를 제공해야 합니다.
- 스폰서 전용 페이지에는 아래 두 회사의 로고와 간략한 회사 소개가 표시되어야 합니다.
  - `https://ebrain.kr/`
...
- AC-006: 일정 문서에는 `2026년 02월 21일(토요일)`, `12:30~19:00+` 기준이 명시된 타임테이블 표가 존재해야 합니다.
